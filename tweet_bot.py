...
def generate_tweet():
    ...
    prompt = f"""
        ...
        1. **投稿の冒頭:** "[おは減税bot] {date_str}" を入れてください。
        2. **本文:** 本日の日付"{date_str}"が持つ何らかの意味（例: 誰かの誕生日、過去の重要な決定があった日など）を軽く触れつつ、社会保障削減と減税の必要性または問題提起を短く含めてください。
        3. **投稿の最後:** "減税しなければ政治家ではない！（AIによる自動生成）" を入れてください。
